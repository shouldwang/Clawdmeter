...
- 尺寸:建議 ≤480×480(對應面板實際解析度),避免韌體端額外做縮放運算;非正方形圖片建議在電腦端先裁切/縮放好,韌體不做 letterbox 或裁切邏輯
...
| Phase 4(lightbox) | ⏸ 擱置(nice to have),2026-07-09 決策改走內建 SPIFFS,不再需要 TF 腳位/GPIO2 前置作業 | — |
